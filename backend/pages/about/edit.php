                ...
                ?>
                 <form action="../../actions/about/update.php?id=<?= $about->id?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                       ...
                       required value="<?= $about->total_project?>">
                    </div>
                     ...
                     <div class="mb-3">
                       ...
                       required value="<?= $about->work?>">
                    </div>

                      <div class="mb-3">
                       <label for="addressinput" class="form-label">Alamat</label>
                       <textarea name="address"  id="addressinput" class="form-control" placeholder="Masukan Alamat" rows="5"><?= $about->address?></textarea >
                    </div>
